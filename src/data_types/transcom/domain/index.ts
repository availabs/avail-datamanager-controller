...
export enum DataSources {
  // The Raw TRANSCOM Expanded Events downloaded from the API.
  TranscomEvent = "TranscomEvent",

  TranscomEventAdministativeGeographies = "TranscomEventAdministativeGeographies",

  TranscomEventsOntoConflationMap = "TranscomEventsOntoConflationMap",

  TranscomEventsOntoRoadNetwork = "TranscomEventsOntoRoadNetwork",

  TranscomEventCongestionData = "TranscomEventCongestionData",

  TranscomEventsByTmcSummary = "TranscomEventsByTmcSummary",
}
...
export const npmrdsDataSourcesInitialMetadataByName = {
  [DataSources.NpmrdsTravelTimesExportRitis]: {
    description:
  ...
  [DataSources.NpmrdsTravelTimesExportEtl]: {
    description:
    ...
    source_dependencies_names: [DataSources.NpmrdsTravelTimesExportRitis],
    metadata: {
      elements: {
  ...
  [DataSources.NpmrdsTravelTimesImp]: {
    description:
    ...
    source_dependencies_names: [DataSources.NpmrdsTravelTimesExportEtl],
  },

  [DataSources.NpmrdsTravelTimes]: {
    description:
    ...
    source_dependencies_names: [DataSources.NpmrdsTravelTimesImp],
  },

  [DataSources.NpmrdsTmcIdentificationImp]: {
    description:
  ...
  [DataSources.NpmrdsTmcIdentification]: {
    ...
    source_dependencies_names: [DataSources.NpmrdsTmcIdentificationImp],
  },
};
