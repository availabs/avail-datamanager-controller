...
INSERT INTO floodplains_work_schema.tmp_dupe_building_ids
  SELECT
      building_id
    FROM floodplains_work_schema.buildings_to_floodplains
  ...
  WITH cte_ranked AS (
    SELECT
      ...
      FROM floodplains_work_schema.tmp_dupe_building_ids
        INNER JOIN floodplains_work_schema.buildings_to_floodplains AS b
          USING ( building_id )
...
DELETE FROM floodplains_work_schema.buildings_to_floodplains
 WHERE (
   ( building_id IN (
       SELECT
           building_id
